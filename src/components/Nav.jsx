  ...
  return (
    <>
      <nav className='lg:w-full py-2 px-2 flex items-center justify-center'>
        ...
        <ul
          className={`h-screen lg:h-auto flex flex-col lg:flex-row items-end py-10 gap-8 text-dark-text-gray font-light text-xl absolute lg:static bg-light-gray lg:bg-transparent lg:w-auto top-0 right-0 lg:top-16 lg:py-0 ${
