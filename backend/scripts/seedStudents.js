...
const students = [
  { "rollNumber": 1, "name": "Tanvi kumari", "class": "LKG" },
  { "rollNumber": 3, "name": "Mohi kumari", "class": "LKG" },
  { "rollNumber": 4, "name": "Suraj kumar", "class": "LKG" },
  { "rollNumber": 6, "name": "Muskan kumari", "class": "LKG" },
  { "rollNumber": 9, "name": "Ankit kumar", "class": "LKG" },
  { "rollNumber": 10, "name": "Rajnish kumar", "class": "LKG" },
  { "rollNumber": 12, "name": "Shubham kumar", "class": "LKG" },
  { "rollNumber": 13, "name": "Smriti kumari", "class": "LKG" },
  { "rollNumber": 14, "name": "Sumit kumar", "class": "LKG" },
  { "rollNumber": 15, "name": "Anushka kumari", "class": "LKG" },
  { "rollNumber": 17, "name": "Manvi Madhukar", "class": "LKG" },
  { "rollNumber": 19, "name": "Arohi kumari", "class": "LKG" },
  { "rollNumber": 20, "name": "Vaishanavi kumari", "class": "LKG" },
  { "rollNumber": 21, "name": "Sushant kumar", "class": "LKG" },
  { "rollNumber": 22, "name": "Harshit Raj", "class": "LKG" },
  { "rollNumber": 23, "name": "Shiwani kumari", "class": "LKG" },
  { "rollNumber": 24, "name": "Adil Alam", "class": "LKG" },
  { "rollNumber": 26, "name": "Hani Priya", "class": "LKG" },
  { "rollNumber": 27, "name": "Dikshit Anand", "class": "LKG" },
  { "rollNumber": 28, "name": "Aditya kumar", "class": "LKG" },
  { "rollNumber": 29, "name": "Roshani kumari", "class": "LKG" },
  { "rollNumber": 30, "name": "Piyush kumar", "class": "LKG" },
  { "rollNumber": 32, "name": "Puja kumari", "class": "LKG" },
  { "rollNumber": 33, "name": "Abhinav kumari", "class": "LKG" },
  { "rollNumber": 35, "name": "Prince Raj", "class": "LKG" },
  { "rollNumber": 36, "name": "Abhishek kumar", "class": "LKG" },
  { "rollNumber": 39, "name": "Rajshree kumari", "class": "LKG" },
  { "rollNumber": 43, "name": "Aditya kumar", "class": "LKG" },
  { "rollNumber": 45, "name": "Devraj kumar", "class": "LKG" },
  { "rollNumber": 46, "name": "Shourya kumar", "class": "LKG" },
  { "rollNumber": 47, "name": "Anurag kumar", "class": "LKG" },
  { "rollNumber": 48, "name": "Sanni kumar", "class": "LKG" },
  { "rollNumber": 49, "name": "Ranjan kumar", "class": "LKG" },
  { "rollNumber": 51, "name": "Beauti kumari", "class": "LKG" },
  { "rollNumber": 52, "name": "Aryan kumar", "class": "LKG" }
]
...
//   { "rollNumber": 2,  "name": "Harekumariishna",     "class": "NURSERY" },
...
//   { "rollNumber": 40, "name": "kumariishna Kumar", "class": "NURSERY" },
...
//   { rollNumber: 2,  name: "kumariishna Kumar",      class: "PG" },
